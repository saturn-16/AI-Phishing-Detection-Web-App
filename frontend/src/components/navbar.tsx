    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <a
          ...
          className="flex items-center gap-2.5 px-4 py-2 rounded-full bg-zinc-900/60 border border-zinc-800 hover:bg-zinc-800/80 hover:border-zinc-700 transition-all text-zinc-300 hover:text-white"
        >
